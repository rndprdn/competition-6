...
const left = array.filter((item, index) => index < 5 || (index > 9 && index < 15)).filter(item => item);

const center = array.filter((item, index) => (index >= 5 && index <= 9) || index > 14).filter(item => item);
